...
wget https://github.com/dirkpetersen/mom/releases/latest/download/mom_0.2.1_ubuntu-2404_amd64.deb
sudo dpkg -i mom_0.2.1_ubuntu-2404_amd64.deb
```

Available packages: `mom_0.2.1_debian-latest_amd64.deb`, `mom_0.2.1_ubuntu-2204_amd64.deb`, `mom_0.2.1_ubuntu-2404_amd64.deb`, `mom_0.2.1_ubuntu-2604_amd64.deb`

### RHEL / Rocky / Alma

```bash
sudo dnf install https://github.com/dirkpetersen/mom/releases/latest/download/mom-0.2.1.el9.x86_64.rpm
```

Available packages: `mom-0.2.1.el9.x86_64.rpm`, `mom-0.2.1.el10.x86_64.rpm`
